...
const EditGymPage = () => {
  ...
  const save = async () => {
    try {
      ...
      // Use legacy endpoint/payload to match older backend API
      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={save}
            disabled={saving}
            className={`h-10 px-4 rounded-xl text-sm font-semibold flex items-center gap-2 ${saving
                        ...
                        return (
                          <div key={field} className="md:col-span-2 space-y-1">
                            ...
                            <textarea
                              ...
                              className={`w-full min-h-[180px] px-3 py-2 rounded-xl border font-mono text-sm outline-none focus:ring-2 ${valid
                            ...
                            <p
                              className={`text-xs ${valid ? "text-slate-500" : "text-red-600"
                                }`}
                            >
